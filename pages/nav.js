...
function Nav(props) {
  ...
  async function getOption() {
    const pro = await axios.post(`${window.origin}/api/logout`, {
  ...
  return (
    <div>
      <div
        id="Dnavbar"
        style={{ position: props.position, width: props.width, zIndex: 100 }}
        className={styles.Mnavbody}
      >
        <Link href={"/"}>
          <a>
      ...
      <div id="mnav" className={styles.Mnavbar}>
        <div className={styles.Mnavs}>
          ...
          <div style={{ display: display }} className={styles.searchbox}>
            {data.length == 0 ? (
              <div style={{ display: display }} className={styles.notfound}>
                Not found
              </div>
            ) : (
      ...
      >
        <div className={styles.navbar}>
          ...
          <div className={styles.searchBound}>
            <input
              type={"search"}
              name="search"
            ...
            {isAuth?.passport ? (
              <div className={styles.dropdown}>
                <div className={styles.avatar}>
                  <Image
                    src={`https://avatars.dicebear.com/api/initials/${isAuth?.passport?.user?.info}.png`}
                    alt="Avatar"
                    width={50}
                    height={50}
                    layout="responsive"
